...
public class PlanetWars 
{
  ...
  {
    Planet source = m_planets[sourcePlanet];
    Planet destination = m_planets[destinationPlanet];
    double dx = source.m_x - destination.m_x;
    double dy = source.m_y - destination.m_y;
